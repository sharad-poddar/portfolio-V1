...
export default function Link(){
    ...
    return(
        <div className='links'> 
            ...
            <a href='https://www.linkedin.com/in/sharad-poddar-895985283/' target='_blank'><motion.i class="fa-brands fa-linkedin" whileHover={{color: '#0A66C2', scale: 1.2}}></motion.i></a>
            ...
            <motion.button transition={{ duration: 0.2, type:'spring'}} whileHover={{backgroundColor: '#a4c3b2'}}><motion.a href='https://github.com/sharad-poddar/portfolio-V1/blob/main/resume/cv.pdf' whileHover={{color: 'white'}}>resume</motion.a></motion.button>
        </div>
    )
}